...
#
# Usage:
#   ./build-local.sh <target> [<target> ...]
#   ./build-local.sh all
#
# Targets:
#   rpm-el8       rockylinux:8
#   rpm-el9       rockylinux:9
...
build_target() {
    case "$1" in
        ...
        rpm-el9)      run_rpm rpm-el9     rockylinux:9   ;;
...
ALL_TARGETS=(rpm-el8 rpm-el9 deb-debian12 deb-debian13 deb-ubuntu22 deb-ubuntu24 deb-ubuntu26)
